...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM pechuga_pollo WHERE id_nutriente = '$id_nutriente'";
...
<body style="background-color: rgb(38, 34, 28);>
    ...
    <title>pechuga_pollo tabla </title>
...
<header>
    ...
    <form class="" action="editar_alimento_pechuga_pollo.php" method="POST">
    <?php
