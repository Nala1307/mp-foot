...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM pechuga_pollo";
...
<body style="background-color: rgb(38, 34, 28);>
    ...
    <title> pechuga pollo tabla </title>
...
if($resultado->num_rows>0){
    ...
    while ($row = $resultado->fetch_assoc()) {
        ...
        echo "<td><a href=\"eliminar_pechuga_pollo.php?id=" . $row["id_nutriente"] . "\">Eliminar</a></td>";


        echo "<td><a href=\"editar_pechuga_pollo.php?id=" . $row["id_nutriente"] . "\">Editar</a></td>";
    ...
    <button onclick="window.location.href='nuevo_alimento_pechuga_pollo.php'"
