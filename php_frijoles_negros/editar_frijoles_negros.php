...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM frijoles_negros WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_frijoles_negros.php" method="POST">
    <?php
