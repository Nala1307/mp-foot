...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM helado_vainilla WHERE id_nutriente = '$id_nutriente'";
...
<body style="background-color: rgb(38, 34, 28);>
    ...
    <title>aceite oliva tabla </title>
...
<header>
    ...
    <form class="" action="editar_alimento_helado_vainilla.php" method="POST">
    <?php
