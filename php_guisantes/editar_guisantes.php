...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM guisantes WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_guisantes.php" method="POST">
    <?php
