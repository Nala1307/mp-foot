...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM lentejas WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_lentejas.php" method="POST">
    <?php
