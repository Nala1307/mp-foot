...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM garbanzos WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_garbanzos.php" method="POST">
    <?php
