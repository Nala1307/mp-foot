...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM zapallo_italiano WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_zapallo_italiano.php" method="POST">
    <?php
