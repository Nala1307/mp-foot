...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM galletas_chips WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_galletas_chips.php" method="POST">
    <?php
