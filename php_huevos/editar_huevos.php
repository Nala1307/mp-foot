...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM huevos WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_huevos.php" method="POST">
    <?php
