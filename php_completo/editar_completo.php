...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM completo WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_completo.php" method="POST">
    <?php
