...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM ketchup WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_ketchup.php" method="POST">
    <?php
