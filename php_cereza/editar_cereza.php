...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM cereza WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_cereza.php" method="POST">
    <?php
