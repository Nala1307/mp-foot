...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM zanahoria WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_zanahoria.php" method="POST">
    <?php
