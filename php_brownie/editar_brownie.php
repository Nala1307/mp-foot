...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM brownie WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_brownie.php" method="POST">
    <?php
