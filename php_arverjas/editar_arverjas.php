...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM arverjas WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_arverjas.php" method="POST">
    <?php
