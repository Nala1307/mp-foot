...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM aceite_vegetal WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento.php" method="POST">
    <?php
