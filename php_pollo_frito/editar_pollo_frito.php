...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM pollo_frito WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_pollo_frito.php" method="POST">
    <?php
