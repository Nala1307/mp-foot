...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM cebolla WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_cebolla.php" method="POST">
    <?php
