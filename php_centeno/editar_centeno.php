...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM centeno WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_centeno.php" method="POST">
    <?php
