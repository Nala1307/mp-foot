...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM queso_crema WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_queso_crema.php" method="POST">
    <?php
