...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM carne_cerdo WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_carne_cerdo.php" method="POST">
    <?php
