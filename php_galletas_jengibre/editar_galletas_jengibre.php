...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM galletas_jengibre WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_galletas_jengibre.php" method="POST">
    <?php
