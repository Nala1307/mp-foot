...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM galletas_jengibre";
...
<body style="background-color: rgb(38, 34, 28);>
    ...
    <title>galletas jengibre tabla </title>
...
if($resultado->num_rows>0){
    ...
    while ($row = $resultado->fetch_assoc()) {
        ...
        echo "<td><a href=\"eliminar_galletas_jengibre.php?id=" . $row["id_nutriente"] . "\">Eliminar</a></td>";


        echo "<td><a href=\"editar_galletas_jengibre.php?id=" . $row["id_nutriente"] . "\">Editar</a></td>";
    ...
    <button onclick="window.location.href='nuevo_alimento_galletas_jengibre.php'"
