...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM pie_limon WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_pie_limon.php" method="POST">
    <?php
