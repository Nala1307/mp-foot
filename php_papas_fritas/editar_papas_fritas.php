...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM papas_fritas WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_papas_fritas.php" method="POST">
    <?php
