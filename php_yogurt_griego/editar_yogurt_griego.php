...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM yogurt_griego WHERE id_nutriente = '$id_nutriente'";
...
<body style="background-color: rgb(38, 34, 28);>
    ...
    <title>yogurt griego tabla </title>
...
<header>
    ...
    <form class="" action="editar_alimento_yogurt_griego.php" method="POST">
    <?php
