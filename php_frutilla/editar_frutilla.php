...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM frutilla WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_frutilla.php" method="POST">
    <?php
