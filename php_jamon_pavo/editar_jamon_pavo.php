...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM jamon_pavo WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_jamon_pavo.php" method="POST">
    <?php
