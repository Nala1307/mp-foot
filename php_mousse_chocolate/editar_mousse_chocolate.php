...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM mousse_chocolate WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_mousse_chocolate.php" method="POST">
    <?php
    if ($resultado->num_rows > 0) {
        echo "<table>";
        echo "<tr><th>Nombre proteina</th><th>valor</th></tr>";
