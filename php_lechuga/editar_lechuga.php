...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM lechuga WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_lechuga.php" method="POST">
    <?php
