...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM mayonesa WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_mayonesa.php" method="POST">
    <?php
