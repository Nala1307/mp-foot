...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM queso_cabra WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_queso_cabra.php" method="POST">
    <?php
