...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM brazo_reina WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_brazo_reina.php" method="POST">
    <?php
