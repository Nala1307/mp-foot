...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM miel";
...
if($resultado->num_rows>0){
    ...
    while ($row = $resultado->fetch_assoc()) {
        ...
        echo "<td><a href=\"eliminar_miel.php?id=" . $row["id_nutriente"] . "\">Eliminar</a></td>";


        echo "<td><a href=\"editar_miel.php?id=" . $row["id_nutriente"] . "\">Editar</a></td>";
    ...
    <button onclick="window.location.href='nuevo_alimento_miel.php'"
