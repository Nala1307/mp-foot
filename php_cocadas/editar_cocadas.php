...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM cocadas WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_cocadas.php" method="POST">
    <?php
