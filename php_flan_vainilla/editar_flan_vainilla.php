...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM flan_vainilla WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_flan_vainilla.php" method="POST">
    <?php
