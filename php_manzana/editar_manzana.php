...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM manzana WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_manzana.php" method="POST">
    <?php
