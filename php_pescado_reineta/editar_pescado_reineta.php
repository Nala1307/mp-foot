...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM pescado_reineta WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_pescado_reineta.php" method="POST">
    <?php
