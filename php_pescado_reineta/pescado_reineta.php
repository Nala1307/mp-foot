...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM pescado_reineta";
...
<body style="background-color: rgb(38, 34, 28);>
    ...
    <title>pescado reineta tabla </title>
...
if($resultado->num_rows>0){
    ...
    while ($row = $resultado->fetch_assoc()) {
        ...
        echo "<td><a href=\"eliminar_pescado_reineta.php?id=" . $row["id_nutriente"] . "\">Eliminar</a></td>";


        echo "<td><a href=\"editar_pescado_reineta.php?id=" . $row["id_nutriente"] . "\">Editar</a></td>";
    ...
    <button onclick="window.location.href='nuevo_alimento_pescado_reineta.php'"
