...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM guisantes_blancos WHERE id_nutriente = '$id_nutriente'";
...
<body style="background-color: rgb(38, 34, 28);>
    ...
    <title>guizantes blancos tabla </title>
...
<header>
    ...
    <form class="" action="editar_alimento_guisantes_blancos.php" method="POST">
    <?php
