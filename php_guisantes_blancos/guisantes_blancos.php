...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM guisantes_blancos";
...
<body style="background-color: rgb(38, 34, 28);>
    ...
    <title>guisantes blancos tabla </title>
    ...
    <div class="container__menu">
        <nav class="menu">
            <ul>
                ...
                <li><a href="../php_SESION/inicio_sesion.php">Inicio de sesion</a></li>
                <li><a href="../php_REGISTRO/registrarse.html">registrarse</a></li>
...
if($resultado->num_rows>0){
    ...
    while ($row = $resultado->fetch_assoc()) {
        ...
        echo "<td><a href=\"eliminar_guisantes_blancos.php?id=" . $row["id_nutriente"] . "\">Eliminar</a></td>";


        echo "<td><a href=\"editar_guisantes_blancos.php?id=" . $row["id_nutriente"] . "\">Editar</a></td>";
    ...
    <button onclick="window.location.href='nuevo_alimento_guisantes_blancos.php'"
