...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM rosquillas WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_rosquillas.php" method="POST">
    <?php
