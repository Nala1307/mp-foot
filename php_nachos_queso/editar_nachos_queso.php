...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM nachos_queso WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_nachos_queso.php" method="POST">
    <?php
