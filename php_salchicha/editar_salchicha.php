...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM salchicha WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_salchicha.php" method="POST">
    <?php
