...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM aceite_oliva WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_aceite_oliva.php" method="POST">
    <?php
