...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM morron_verde WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_morron_verde.php" method="POST">
    <?php
