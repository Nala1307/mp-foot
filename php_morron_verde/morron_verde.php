...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM morron_verde";
...
<body style="background-color: rgb(38, 34, 28);>
    ...
    <title>morron verde tabla </title>
...
if($resultado->num_rows>0){
    ...
    while ($row = $resultado->fetch_assoc()) {
        ...
        echo "<td><a href=\"eliminar_morron_verde.php?id=" . $row["id_nutriente"] . "\">Eliminar</a></td>";


        echo "<td><a href=\"editar_morron_verde.php?id=" . $row["id_nutriente"] . "\">Editar</a></td>";
    ...
    <button onclick="window.location.href='nuevo_alimento_morron_verde.php'"
