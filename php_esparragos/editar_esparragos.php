...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM esparragos WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_esparragos.php" method="POST">
    <?php
