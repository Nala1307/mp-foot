...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM pizza_peperoni WHERE id_nutriente = '$id_nutriente'";
...
<body style="background-color: rgb(38, 34, 28);>
    ...
    <title>pizza peperoni tabla </title>
...
<header>
    ...
    <form class="" action="editar_alimento_pizza.php" method="POST">
    <?php
