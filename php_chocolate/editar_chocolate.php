...
$consulta = "SELECT id_nutriente, nombre_nutriente, valor FROM chocolate WHERE id_nutriente = '$id_nutriente'";
...
<header>
    ...
    <form class="" action="editar_alimento_chocolate.php" method="POST">
    <?php
